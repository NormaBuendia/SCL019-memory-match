import shuffleFunction from '../shuffle.js';
//import cardSelectionFunction from '../shuffle.js';
  ...
  for (let i = 0; i < shuffle.length; i++) {
    ...
    const checkCards = (e) => {
      ...
      if (flippedCards.length === 2) {
        ...
        //let cardSelection = cardSelectionFunction()
        
        //if( cardSelection === flippedCards){
